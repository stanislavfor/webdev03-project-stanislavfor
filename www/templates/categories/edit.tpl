<div class="container">
	<div class="row">
		<div class="col-xl-10 offset-1">
			...
			<form actoin="<?=HOST?>blog/category-edit?id=<?=$cat['id']?>" method="POST" class="form mb-100 pb-20 pt-35">

				<div class="fieldset">
					<label>
						<div class="fieldset__title">Название категории</div>
						<input class="input" placeholder="Введите название" name="catTitle" value="<?=$cat['cat_title']?>"  />
					</label>
					</div>
